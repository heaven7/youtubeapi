...
class Tx_Youtubeapi_Controller_FeedController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_Youtubeapi_Domain_Repository_FeedRepository
	 */
	...
	protected function initializeAction() {
		$this->feedRepository = t3lib_div::makeInstance('Tx_Youtubeapi_Domain_Repository_FeedRepository');
	}
